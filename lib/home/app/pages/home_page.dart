                ...
                children: [
                  ...
                  Observer(
                    builder: (context) => SizedBox(
                      ...
                      child: Padding(
                        padding:  EdgeInsets.all(DeviceInfo.screenHeight/20),
                        child: Container(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                title: Padding(
                                  padding: EdgeInsets.symmetric(horizontal: DeviceInfo.screenWidth/20),
                                  child: Center(
                                      child: Text(
                  ...
                  Padding(padding: EdgeInsets.all(DeviceInfo.screenHeight/15)),
                ],
              ),
            ),
          ));
